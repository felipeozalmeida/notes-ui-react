const NoteForm = () => {
    return <form className="flex flex-col items-stretch justify-center gap-3">
        ...
        <div className="flex flex-col gap-1 items-stretch justify-between">
            ...
            <select className="px-2 py-1 border border-neutral-300 rounded-xl" name="priority" id="priority">
        ...
        <div className="flex flex-col gap-1 items-stretch justify-between">
            ...
            <select className="px-2 py-1 border border-neutral-300 rounded-xl" name="category" id="category">
