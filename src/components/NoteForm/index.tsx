...
const NoteForm = () => {
    ...
    return <form className="flex flex-col gap-3 items-stretch justify-center">
        <div className="flex flex-col gap-1 items-stretch justify-between">
            ...
            <input className="h-8 px-2 border border-neutral-300 rounded-full" type="text" id="title" name="title" placeholder="fix github actions yml" value={title} onChange={(e) => { setTitle(e.target.value) }} />
        </div>
        <div className="flex flex-col gap-2 sm:flex-row sm:items-stretch sm:justify-between">
            <div className="flex flex-col gap-1 items-stretch justify-between sm:basis-4/12">
                ...
                <select className="h-8 px-2 border border-neutral-300 rounded-full" name="priority" id="priority" value={priority} onChange={(e) => { setPriority(e.target.value) }}>
            ...
            <div className="flex flex-col gap-1 items-stretch justify-between sm:basis-8/12">
                ...
                <select className="h-8 px-2 border border-neutral-300 rounded-full" name="category" id="category" value={category} onChange={(e) => { setCategory(e.target.value) }}>
        ...
        <div className="flex flex-col gap-1 items-stretch justify-between">
            ...
            <input className="h-8 px-2 border border-neutral-300 rounded-full" type="text" id="description" name="description" placeholder="wth is happening with that pipeline?!" value={description} onChange={(e) => { setDescription(e.target.value) }} />
        </div>
